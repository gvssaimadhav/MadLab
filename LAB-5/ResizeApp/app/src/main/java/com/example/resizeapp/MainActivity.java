...
protected void onCreate(Bundle savedInstanceState)
    ...
    iv1.startAnimation(animZoomIn); iv2.startAnimation(animZoomOut2);
    ...
    animZoomIn2.setAnimationListener(new Animation.AnimationListener() { @Override
    public void onAnimationStart(Animation animation) {	} @Override
